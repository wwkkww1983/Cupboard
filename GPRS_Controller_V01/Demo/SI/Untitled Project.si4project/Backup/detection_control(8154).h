...
#define KEY_WAKEUP_CNT_MAX      300//0.1s 按键唤醒时间
#define TIME_WAKEUP_CNT_MAX     300//0.1s 定时唤醒时间
...
typedef struct
{
    ...
    uint8_t WorkMode;           //工作状态 1关锁 0-开锁
    ...
    uint8_t IMEI_Buffer[16];//359759002514931
